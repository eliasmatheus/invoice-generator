...
invoice = Invoice("24-008", 2024, "Aug", 30, "U$ 2,166.67")
sender = Sender(
...
msg = outlook.make(
    ...
    with_properties={k.subject: subject, k.content: content + signature},
)

msg.make(
    new=k.recipient,
    with_properties={
        k.email_address: {k.name: recipient.name, k.address: recipient.email}
    },
)
